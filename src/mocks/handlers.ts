...
function success<D>(data: D): Response {
  return HttpResponse.json<SuccessResult<D>>({ status: "success", data });
}

function gateRequired(request: Request, intent: GatedIntent): Response {
...
function serverError(message = "mock server unavailable"): Response {
